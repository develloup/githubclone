...
func GetRepositoryPullRequests(c *gin.Context) {
	...
	// 	"field":     {"CREATED_AT": true, "UPDATED_AT": true, "MERGED_AT": true, "COMMENTS": true},
	// 	"direction": {"ASC": true, "DESC": true},
	// })

	// // API-Request ausführen
	// var pullRequestsData GitHubRepositoryPullRequestsResponse
	// err = common.SendGraphQLQuery("https://api.github.com/graphql", github.GithubRepoPullRequestsQuery, token, validParams, &pullRequestsData)
	// if err != nil {
	// 	c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
	// 	return
	// }

	// c.JSON(http.StatusOK, pullRequestsData)
}
