...
import { SettingIcon, SignInIcon, SignOutIcon, UserIcon } from "./Icons";
  ...
  return (
    <Sheet open={rightOpen} onOpenChange={(isOpen) => setRightOpen(isOpen)}>
      ...
      <SheetContent side="right" className="rounded-lg">
        ...
        {oauthUrls && (
            <div className="flex flex-col space-y-1 mt-1">
                {/* 🔹 Trennlinie & Titel direkt in den Block integriert */}
                <div className="h-px bg-gray-400 my-1 mx-2" />
                <div className="flex items-center">
                    <span className="text-xs font-semibold pl-3">OAuth accounts</span>
                </div>
